...
import com.example.contract.taskmanager.dto.ChecklistTemplateRequest;
...
import com.example.contract.taskmanager.repository.ChecklistTemplateRepository;
...
public class ChecklistController {
    ...
    public List<ChecklistTemplate> getTemplatesByUser(@PathVariable("userId") Integer userId) {
        return templateRepo.findByCreatedBy(userId);
    }

    @GetMapping("/templates/{id}/items")
    public List<ChecklistTemplateItem> getTemplateItems(@PathVariable("id") Long id) {
        return itemRepo.findByTemplateId(id);
    }

    @DeleteMapping("/templates/{id}")
    @Transactional
    public Map<String, String> deleteTemplate(@PathVariable("id") Long id) {
